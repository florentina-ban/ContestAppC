    ...
    public class RepoSignUp : IRepoSignUp
    {
        ...
        public IList<SignUp> FindAll()
        {
            ...
            try
            {
                ...
                {
                    SignUp signUp=new SignUp(this.RepoParticipants.FindOne(dto.ParicipantId), this.RepoCompetitions.FindOne(dto.CompetitionId));
                    signUp.Participant.NoComp = this.NoSignUpsForParticipant(dto.ParicipantId);
                    all.Add(signUp);
                }
            }
            catch (Exception ex)
        ...
        public SignUp FindOne(int id)
        {
            ...
            try
            {
                ...
                signUp.Participant.NoComp = this.NoSignUpsForParticipant(signUpDTO.ParicipantId);
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
        ...
        public IList<Participant> getParticipantsForCompetition(int IdComp)
        {
            ...
            try {
                ...
                foreach (var id in allIds)
                {
                    Participant part = this.RepoParticipants.FindOne(id);
                    part.NoComp = this.NoSignUpsForParticipant(id);
                    allPart.Add(part);
                }
            }
            catch (Exception ex)
